...
# Create DataFrame
df = pd.read_excel(f"{os.getcwd()}/results/FINAL RESULTS Election Slugbot base model.xlsx", sheet_name="gpt4o-mini")
...
# st.dataframe(pd.DataFrame(df["standardised_party_winner"].value_counts()))
